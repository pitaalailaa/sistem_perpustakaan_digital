...
.judul{color:white;font-size:20px;line-height:1.2;margin:0;}
...
.content{flex:1;padding:30px;color:white;overflow-y:auto;}
.table-card{background:#0f172a;padding:25px;border-radius:16px;box-shadow:0 10px 30px rgba(0,0,0,0.25);}
.table-card h2{margin-top:0;color:#3b82f6;}
...
.badge{display:inline-block;padding:6px 12px;border-radius:999px;background:#2563eb;color:white;font-weight:bold;font-size:12px;}
</style>
</head>
<body>
  ...
  <div class="main">
    ...
    <div class="content">
      <div class="table-card">
        <h2>Data Anggota</h2>
        @if(session('success'))<p style="color:#4ade80;text-align:center;">{{ session('success') }}</p>@endif
        <table>
          <tr>
            <th>No</th>
            <th>Nama</th>
