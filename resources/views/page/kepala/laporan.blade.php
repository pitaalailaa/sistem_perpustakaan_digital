        ...
        <div class="main">
            ...
            <div class="content">
                ...
                <div class="section">
                            ...
                            <tbody>
                                @forelse($recent as $index => $r)
                                    <tr>
                                        ...
                                        <td>{{ $r->user->name }}</td>
                                        <td>{{ $r->buku->judul }}</td>
                                        <td>{{ $r->borrowed_at ? \Carbon\Carbon::parse($r->borrowed_at)->format('d/m/Y') : '-' }}
                                        </td>
                                        <td>
                                            <span
                                                style="
                    ...
                    @elseif($r->status == 'dikembalikan') background: #d1d5db; color: #1f2937; @endif
                  ">
                                                {{ ucfirst($r->status) }}
                                            </span>
                                        </td>
                ...
                <!-- FOOTER -->
                <div
                    style="text-align: center; margin-top: 50px; padding-top: 20px; border-top: 1px solid #334155; color: #64748b; font-size: 12px;">
