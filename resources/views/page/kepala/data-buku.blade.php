       ...
       <!-- HEADER -->
        <div class="header">
            <div class="header-content">
                ...
                <!-- KIRI -->
                <div class="left-box">
                    <div class="logo"><img src="{{ asset('images/logoperpus.png') }}">
                    </div>
                ...
                <!-- USER BOX -->
                <div class="user-box">
                    <img src="{{ asset('images/profil.png') }}"><span>{{ auth()->user()->name }}
        ...
        <div class="main">
            ...
            <div class="content">
                <h2 style="text-align:center;">Data Buku (Katalog + Kategori)</h2>
